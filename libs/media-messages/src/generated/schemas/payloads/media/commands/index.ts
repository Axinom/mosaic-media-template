...
import * as StartIngestItemCommand from './start-ingest-item-command.json';
import * as UnpublishEntityCommand from './unpublish-entity-command.json';
...
export const StartIngestItemCommandSchema = StartIngestItemCommand;
export const UnpublishEntityCommandSchema = UnpublishEntityCommand;
export const UpdateMetadataCommandSchema = UpdateMetadataCommand;