...
import { useProgramDetailsRootPathParamsQuery } from '../../../../generated/graphql';
 ...
 */
export const ProgramDetailsReRouter: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (playlistId) {
      history.replace(
        routes.generate(routes.programDetails, {
  ...
  return (
    <EmptyStation title="Program" stationError={stationError}>
