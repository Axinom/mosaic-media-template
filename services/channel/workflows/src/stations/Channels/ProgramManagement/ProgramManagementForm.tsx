...
import { ProgramManagementFormContent } from './ProgramManagementFormContent/ProgramManagementFormContent';
import { ProgramManagementProvider } from './ProgramManagementProvider/ProgramManagementProvider';

interface ProgramManagementFormProps {
  channelId: string;
  playlistId: string;
}

export const ProgramManagementForm: React.FC<ProgramManagementFormProps> = ({
  channelId,
  playlistId,
}) => {
