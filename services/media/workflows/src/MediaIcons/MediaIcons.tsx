  ...
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
      <path
        ...
        stroke="#00467D"
        strokeWidth="2"
        d="M3.9,3h31.3v11H3.9V3ZM35.2,14v4.9M21.6,25H3.9v-11M21.6,36H3.9v-11M8,7h2.8v2.8h-2.8v-2.8ZM14.2,7h2.8v2.8h-2.8v-2.8ZM36.1,26.8l-5.4-5.4-5.4,5.4M30.7,21.4v15.6"
      />
    </svg>
  );
};
