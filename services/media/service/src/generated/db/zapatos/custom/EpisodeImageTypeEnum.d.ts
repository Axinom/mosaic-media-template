...
declare module 'zapatos/custom' {
  export type EpisodeImageTypeEnum = 'EPISODE_COVER_1x1' | 'EPISODE_COVER_16x9' | 'EPISODE_CLEAN_COVER_1x1' | 'EPISODE_CLEAN_COVER_16x9' | 'EPISODE_LIST_1x1' | 'EPISODE_LIST_9x13';
}
