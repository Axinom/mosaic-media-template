...
--
-- Name: tg_reviews__check_active_snapshots(); Type: FUNCTION; Schema: app_hidden; Owner: -
--

CREATE FUNCTION app_hidden.tg_reviews__check_active_snapshots() RETURNS trigger
    LANGUAGE plpgsql STABLE
    AS $$ BEGIN IF EXISTS (SELECT '' FROM app_public.snapshots s INNER JOIN app_public.reviews_snapshots es ON es.snapshot_id = s.id WHERE es.review_id = OLD.id AND s.snapshot_state IN ('INITIALIZATION', 'VALIDATION', 'PUBLISHED')) THEN perform ax_utils.raise_error('%s with ID %s cannot be deleted as it has active snapshots.', 'ACSNS', 'Review', OLD.id::text); END IF; RETURN OLD; END; $$;
...
--
-- Name: tg_snapshots__propagate_publish_state_to_reviews(); Type: FUNCTION; Schema: app_hidden; Owner: -
--

CREATE FUNCTION app_hidden.tg_snapshots__propagate_publish_state_to_reviews() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$ BEGIN IF (NEW.snapshot_state = 'PUBLISHED') THEN UPDATE app_public.reviews SET published_date = NEW.published_date, published_user = NEW.updated_user, publish_status = CASE WHEN updated_date > NEW.created_date THEN 'CHANGED' ELSE 'PUBLISHED' END WHERE id = NEW.entity_id;ELSIF (NEW.snapshot_state = 'UNPUBLISHED') THEN UPDATE app_public.reviews SET publish_status = 'NOT_PUBLISHED', published_date = NULL, published_user = NULL WHERE id = NEW.entity_id;END IF; RETURN NEW; END; $$;
...
--
-- Name: reviews; Type: TABLE; Schema: app_public; Owner: -
--
...
--
-- Name: TABLE reviews; Type: COMMENT; Schema: app_public; Owner: -
--
...
--
-- Name: reviews_id_seq; Type: SEQUENCE; Schema: app_public; Owner: -
--

ALTER TABLE app_public.reviews ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME app_public.reviews_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: reviews_snapshots; Type: TABLE; Schema: app_public; Owner: -
--
...
--
-- Name: reviews reviews_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--
...
--
-- Name: reviews_snapshots reviews_snapshots_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.reviews_snapshots
    ADD CONSTRAINT reviews_snapshots_pkey PRIMARY KEY (review_id, snapshot_id);
...
--
-- Name: idx_reviews_publish_status; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_reviews_publish_status ON app_public.reviews USING btree (publish_status);


--
-- Name: idx_reviews_rating; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_reviews_rating ON app_public.reviews USING btree (rating);


--
-- Name: idx_reviews_rating_asc_with_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_reviews_rating_asc_with_id ON app_public.reviews USING btree (rating, id);


--
-- Name: idx_reviews_rating_desc_with_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_reviews_rating_desc_with_id ON app_public.reviews USING btree (rating DESC, id);


--
-- Name: idx_reviews_title_asc_with_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_reviews_title_asc_with_id ON app_public.reviews USING btree (title, id);


--
-- Name: idx_reviews_title_desc_with_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_reviews_title_desc_with_id ON app_public.reviews USING btree (title DESC, id);
...
--
-- Name: idx_trgm_reviews_description; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_trgm_reviews_description ON app_public.reviews USING gin (description public.gin_trgm_ops);


--
-- Name: idx_trgm_reviews_title; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_trgm_reviews_title ON app_public.reviews USING gin (title public.gin_trgm_ops);
...
--
-- Name: reviews _100_check_active_snapshots; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _100_check_active_snapshots BEFORE DELETE ON app_public.reviews FOR EACH ROW EXECUTE FUNCTION app_hidden.tg_reviews__check_active_snapshots();
...
--
-- Name: reviews _100_timestamps; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _100_timestamps BEFORE UPDATE ON app_public.reviews FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION ax_utils.tg__timestamps();
...
--
-- Name: reviews _200_username; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _200_username BEFORE UPDATE ON app_public.reviews FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION ax_utils.tg__username();
...
--
-- Name: reviews _200_username_before_insert; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _200_username_before_insert BEFORE INSERT ON app_public.reviews FOR EACH ROW EXECUTE FUNCTION ax_utils.tg__username();
...
--
-- Name: snapshots _300_propagate_publish_state_to_reviews; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _300_propagate_publish_state_to_reviews BEFORE UPDATE ON app_public.snapshots FOR EACH ROW WHEN (((new.entity_type)::text = 'REVIEW'::text)) EXECUTE FUNCTION app_hidden.tg_snapshots__propagate_publish_state_to_reviews();
...
--
-- Name: reviews _300_publish_state_changed; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _300_publish_state_changed BEFORE UPDATE ON app_public.reviews FOR EACH ROW EXECUTE FUNCTION app_hidden.tg__update_publish_state();
...
--
-- Name: reviews _500_gql_reviews_deleted; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _500_gql_reviews_deleted BEFORE DELETE ON app_public.reviews FOR EACH ROW EXECUTE FUNCTION ax_utils.tg__graphql_subscription('REVIEW_DELETED', 'graphql:reviews', 'id');


--
-- Name: reviews _500_gql_reviews_inserted; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _500_gql_reviews_inserted AFTER INSERT ON app_public.reviews FOR EACH ROW EXECUTE FUNCTION ax_utils.tg__graphql_subscription('REVIEW_CREATED', 'graphql:reviews', 'id');


--
-- Name: reviews _500_gql_reviews_updated; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _500_gql_reviews_updated AFTER UPDATE ON app_public.reviews FOR EACH ROW EXECUTE FUNCTION ax_utils.tg__graphql_subscription('REVIEW_CHANGED', 'graphql:reviews', 'id');
...
--
-- Name: reviews_snapshots tg_cleanup_orphaned_review_snapshots; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER tg_cleanup_orphaned_review_snapshots AFTER DELETE ON app_public.reviews_snapshots FOR EACH ROW EXECUTE FUNCTION app_public.remove_orphaned_snapshot();
...
--
-- Name: reviews reviews_publish_status_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.reviews
    ADD CONSTRAINT reviews_publish_status_fkey FOREIGN KEY (publish_status) REFERENCES app_public.publish_status(value);


--
-- Name: reviews_snapshots reviews_snapshots_review_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.reviews_snapshots
    ADD CONSTRAINT reviews_snapshots_review_id_fkey FOREIGN KEY (review_id) REFERENCES app_public.reviews(id) ON DELETE CASCADE;


--
-- Name: reviews_snapshots reviews_snapshots_snapshot_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.reviews_snapshots
    ADD CONSTRAINT reviews_snapshots_snapshot_id_fkey FOREIGN KEY (snapshot_id) REFERENCES app_public.snapshots(id) ON DELETE CASCADE;
...
--
-- Name: reviews; Type: ROW SECURITY; Schema: app_public; Owner: -
--

ALTER TABLE app_public.reviews ENABLE ROW LEVEL SECURITY;

--
-- Name: reviews reviews_authorization; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY reviews_authorization ON app_public.reviews USING ((( SELECT ax_utils.user_has_permission('REVIEWS_VIEW,REVIEWS_EDIT,ADMIN'::text) AS user_has_permission) AND (1 = 1))) WITH CHECK ((( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission) AND (1 = 1)));


--
-- Name: reviews reviews_authorization_delete; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY reviews_authorization_delete ON app_public.reviews AS RESTRICTIVE FOR DELETE USING (( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission));


--
-- Name: reviews_snapshots; Type: ROW SECURITY; Schema: app_public; Owner: -
--

ALTER TABLE app_public.reviews_snapshots ENABLE ROW LEVEL SECURITY;

--
-- Name: reviews_snapshots reviews_snapshots_authorization; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY reviews_snapshots_authorization ON app_public.reviews_snapshots USING ((( SELECT ax_utils.user_has_permission('REVIEWS_VIEW,REVIEWS_EDIT,ADMIN'::text) AS user_has_permission) AND (1 = 1))) WITH CHECK ((( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission) AND (1 = 1)));


--
-- Name: reviews_snapshots reviews_snapshots_authorization_delete; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY reviews_snapshots_authorization_delete ON app_public.reviews_snapshots AS RESTRICTIVE FOR DELETE USING (( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission));
...
--
-- Name: snapshots snapshots_review_authorization_delete; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_review_authorization_delete ON app_public.snapshots FOR DELETE USING ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission)));


--
-- Name: snapshots snapshots_review_authorization_insert; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_review_authorization_insert ON app_public.snapshots FOR INSERT WITH CHECK ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission)));


--
-- Name: snapshots snapshots_review_authorization_select; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_review_authorization_select ON app_public.snapshots FOR SELECT USING ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT app_hidden.user_has_filter_permission('REVIEWS_VIEW,REVIEWS_EDIT,ADMIN'::text) AS user_has_filter_permission) AND ( SELECT ax_utils.user_has_permission('REVIEWS_VIEW,REVIEWS_EDIT,MOVIES_VIEW,MOVIES_EDIT,TVSHOWS_VIEW,TVSHOWS_EDIT,SETTINGS_VIEW,SETTINGS_EDIT,COLLECTIONS_VIEW,COLLECTIONS_EDIT,ADMIN'::text) AS user_has_permission)));


--
-- Name: snapshots snapshots_review_authorization_update; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_review_authorization_update ON app_public.snapshots FOR UPDATE USING ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission))) WITH CHECK ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission)));
...
--
-- Name: snapshot_validation_results snapshots_validation_review_authorization_delete; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_validation_review_authorization_delete ON app_public.snapshot_validation_results FOR DELETE USING ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission)));


--
-- Name: snapshot_validation_results snapshots_validation_review_authorization_insert; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_validation_review_authorization_insert ON app_public.snapshot_validation_results FOR INSERT WITH CHECK ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission)));


--
-- Name: snapshot_validation_results snapshots_validation_review_authorization_select; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_validation_review_authorization_select ON app_public.snapshot_validation_results FOR SELECT USING ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT app_hidden.user_has_filter_permission('REVIEWS_VIEW,REVIEWS_EDIT,ADMIN'::text) AS user_has_filter_permission) AND ( SELECT ax_utils.user_has_permission('REVIEWS_VIEW,REVIEWS_EDIT,MOVIES_VIEW,MOVIES_EDIT,TVSHOWS_VIEW,TVSHOWS_EDIT,SETTINGS_VIEW,SETTINGS_EDIT,COLLECTIONS_VIEW,COLLECTIONS_EDIT,ADMIN'::text) AS user_has_permission)));


--
-- Name: snapshot_validation_results snapshots_validation_review_authorization_update; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY snapshots_validation_review_authorization_update ON app_public.snapshot_validation_results FOR UPDATE USING ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission))) WITH CHECK ((((entity_type)::text = 'REVIEW'::text) AND ( SELECT ax_utils.user_has_permission('REVIEWS_EDIT,ADMIN'::text) AS user_has_permission)));
...
--
-- Name: FUNCTION tg_reviews__check_active_snapshots(); Type: ACL; Schema: app_hidden; Owner: -
--

REVOKE ALL ON FUNCTION app_hidden.tg_reviews__check_active_snapshots() FROM PUBLIC;
GRANT ALL ON FUNCTION app_hidden.tg_reviews__check_active_snapshots() TO media_service_gql_role;
...
--
-- Name: FUNCTION tg_snapshots__propagate_publish_state_to_reviews(); Type: ACL; Schema: app_hidden; Owner: -
--

REVOKE ALL ON FUNCTION app_hidden.tg_snapshots__propagate_publish_state_to_reviews() FROM PUBLIC;
GRANT ALL ON FUNCTION app_hidden.tg_snapshots__propagate_publish_state_to_reviews() TO media_service_gql_role;
...
--
-- Name: TABLE reviews; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,DELETE ON TABLE app_public.reviews TO media_service_gql_role;


--
-- Name: COLUMN reviews.title; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(title),UPDATE(title) ON TABLE app_public.reviews TO media_service_gql_role;


--
-- Name: COLUMN reviews.description; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(description),UPDATE(description) ON TABLE app_public.reviews TO media_service_gql_role;


--
-- Name: COLUMN reviews.rating; Type: ACL; Schema: app_public; Owner: -
--
...
--
-- Name: COLUMN reviews.publish_status; Type: ACL; Schema: app_public; Owner: -
--

GRANT UPDATE(publish_status) ON TABLE app_public.reviews TO media_service_gql_role;


--
-- Name: SEQUENCE reviews_id_seq; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,USAGE ON SEQUENCE app_public.reviews_id_seq TO media_service_gql_role;


--
-- Name: TABLE reviews_snapshots; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,INSERT,DELETE ON TABLE app_public.reviews_snapshots TO media_service_gql_role;


--
-- Name: COLUMN reviews_snapshots.review_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT UPDATE(review_id) ON TABLE app_public.reviews_snapshots TO media_service_gql_role;


--
-- Name: COLUMN reviews_snapshots.snapshot_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT UPDATE(snapshot_id) ON TABLE app_public.reviews_snapshots TO media_service_gql_role;
