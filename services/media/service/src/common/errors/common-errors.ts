export const CommonErrors = {
  ...
  IngestError: {
    message: `An error has occurred during the ingest process. The actual message will have more information.`,
    code: 'INGEST_ERROR',
  },
  ...
  UnsupportedIngestMediaType: {
    message: `Unable to generate display title for ingest item. Ingest media type '%s' is not supported.`,
  ...
  NotEnoughPermissions: {
    message: `The subject was provided, but it does not have enough permissions to perform the operation.`,
