--! Previous: -
--! Hash: sha1:7a50d1553e24e89387eec24fbe58ba89aeeb8e98
...
ALTER default privileges IN SCHEMA public, app_public, app_hidden, ax_utils GRANT usage, SELECT ON sequences TO ":DATABASE_GQL_ROLE";
ALTER default privileges IN SCHEMA public, app_public, app_hidden, ax_utils GRANT EXECUTE ON functions TO ":DATABASE_GQL_ROLE";
