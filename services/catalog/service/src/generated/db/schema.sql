...
--
-- Name: channel_video_streams; Type: TABLE; Schema: app_public; Owner: -
--

CREATE TABLE app_public.channel_video_streams (
    id integer NOT NULL,
    channel_video_id integer,
    label text,
    key_id text,
    format text,
    iv text,
    ...
    language_name text,
    type app_public.video_stream_type_enum DEFAULT 'VIDEO'::text
);


--
-- Name: channel_video_streams_id_seq; Type: SEQUENCE; Schema: app_public; Owner: -
--

ALTER TABLE app_public.channel_video_streams ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME app_public.channel_video_streams_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: channel_videos; Type: TABLE; Schema: app_public; Owner: -
--
...
--
-- Name: channel_videos_id_seq; Type: SEQUENCE; Schema: app_public; Owner: -
--

ALTER TABLE app_public.channel_videos ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME app_public.channel_videos_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: channel_video_streams channel_video_streams_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.channel_video_streams
    ADD CONSTRAINT channel_video_streams_pkey PRIMARY KEY (id);


--
-- Name: channel_videos channel_videos_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.channel_videos
...
--
-- Name: idx_channel_video_streams_channel_video_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_channel_video_streams_channel_video_id ON app_public.channel_video_streams USING btree (channel_video_id);


--
-- Name: idx_channel_video_streams_type; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_channel_video_streams_type ON app_public.channel_video_streams USING btree (type);


--
-- Name: idx_channel_videos_channel_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_channel_videos_channel_id ON app_public.channel_videos USING btree (channel_id);


--
-- Name: idx_channel_videos_type; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_channel_videos_type ON app_public.channel_videos USING btree (type);
...
--
-- Name: channel_video_streams channel_video_streams_channel_video_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.channel_video_streams
    ADD CONSTRAINT channel_video_streams_channel_video_id_fkey FOREIGN KEY (channel_video_id) REFERENCES app_public.channel_videos(id) ON DELETE CASCADE;


--
-- Name: channel_video_streams channel_video_streams_type_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.channel_video_streams
    ADD CONSTRAINT channel_video_streams_type_fkey FOREIGN KEY (type) REFERENCES app_public.video_stream_type(value);


--
-- Name: channel_videos channel_videos_channel_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.channel_videos
    ADD CONSTRAINT channel_videos_channel_id_fkey FOREIGN KEY (channel_id) REFERENCES app_public.channel(id) ON DELETE CASCADE;
...
--
-- Name: TABLE channel_video_streams; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE app_public.channel_video_streams TO catalog_service_gql_role;


--
-- Name: SEQUENCE channel_video_streams_id_seq; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,USAGE ON SEQUENCE app_public.channel_video_streams_id_seq TO catalog_service_gql_role;


--
-- Name: TABLE channel_videos; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE app_public.channel_videos TO catalog_service_gql_role;


--
-- Name: SEQUENCE channel_videos_id_seq; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,USAGE ON SEQUENCE app_public.channel_videos_id_seq TO catalog_service_gql_role;
