...
--
-- Name: review; Type: TABLE; Schema: app_public; Owner: -
--
...
--
-- Name: TABLE review; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.review IS '@omit
@name review_data';


--
-- Name: review_localizations; Type: TABLE; Schema: app_public; Owner: -
--

CREATE TABLE app_public.review_localizations (
    id integer NOT NULL,
    review_id text,
    locale text NOT NULL,
    is_default_locale boolean NOT NULL,
...
--
-- Name: TABLE review_localizations; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.review_localizations IS '@omit';


--
-- Name: review_localizations_id_seq; Type: SEQUENCE; Schema: app_public; Owner: -
--

ALTER TABLE app_public.review_localizations ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME app_public.review_localizations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: review_view; Type: VIEW; Schema: app_public; Owner: -
--

CREATE VIEW app_public.review_view AS
 SELECT p.id,
    p.rating,
    l.title,
    l.description
   FROM (app_public.review_localizations l
     JOIN app_public.review p ON ((l.review_id = p.id)))
  WHERE (l.locale = ( SELECT current_setting('mosaic.locale'::text, true) AS current_setting));


--
-- Name: VIEW review_view; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON VIEW app_public.review_view IS '@name review
@primaryKey id';
...
--
-- Name: review_localizations review_localizations_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.review_localizations
    ADD CONSTRAINT review_localizations_pkey PRIMARY KEY (id);


--
-- Name: review review_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.review
...
--
-- Name: idx_review_localizations_locale; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_review_localizations_locale ON app_public.review_localizations USING btree (locale);


--
-- Name: idx_review_localizations_review_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_review_localizations_review_id ON app_public.review_localizations USING btree (review_id);


--
-- Name: idx_review_localizations_title_asc_with_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_review_localizations_title_asc_with_id ON app_public.review_localizations USING btree (title, review_id);


--
-- Name: idx_review_localizations_title_desc_with_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_review_localizations_title_desc_with_id ON app_public.review_localizations USING btree (title DESC, review_id);
...
--
-- Name: idx_trgm_review_localizations_title; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_trgm_review_localizations_title ON app_public.review_localizations USING gin (title public.gin_trgm_ops);
...
--
-- Name: review_localizations review_localizations_review_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.review_localizations
    ADD CONSTRAINT review_localizations_review_id_fkey FOREIGN KEY (review_id) REFERENCES app_public.review(id) ON DELETE CASCADE;
...
--
-- Name: TABLE review; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.review TO catalog_service_gql_role;


--
-- Name: TABLE review_localizations; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.review_localizations TO catalog_service_gql_role;


--
-- Name: SEQUENCE review_localizations_id_seq; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,USAGE ON SEQUENCE app_public.review_localizations_id_seq TO catalog_service_gql_role;


--
-- Name: TABLE review_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.review_view TO catalog_service_gql_role;
