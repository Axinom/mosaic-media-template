...
--
-- Name: TABLE collection_images; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.collection_images IS '@omit
...
--
-- Name: collection_images_view; Type: VIEW; Schema: app_public; Owner: -
--
...
--
-- Name: VIEW collection_images_view; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON VIEW app_public.collection_images_view IS '@name collection_images
@primaryKey id';
...
--
-- Name: TABLE episode_images; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.episode_images IS '@omit
...
--
-- Name: episode_images_view; Type: VIEW; Schema: app_public; Owner: -
--
...
--
-- Name: VIEW episode_images_view; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON VIEW app_public.episode_images_view IS '@name episode_images
@primaryKey id';
...
CREATE TABLE app_public.episode_licenses (
    ...
    downloaded_asset_lifespan integer,
    business_type text,
    tier text,
    content_owner text
);
...
--
-- Name: episode_videos_view; Type: VIEW; Schema: app_public; Owner: -
--

CREATE VIEW app_public.episode_videos_view AS
   ...
   FROM ( WITH ts AS (
                 ...
                 SELECT el.episode_id,
                   ...
                   FROM (app_public.episode_licenses el
                     CROSS JOIN ts)
                  WHERE (ts.current_ts < COALESCE(el.end_time, ('infinity'::timestamp without time zone)::timestamp with time zone))
                ), trailer_countries AS (
                 SELECT DISTINCT bl.episode_id,
                        CASE
                            WHEN ((bl.countries IS NOT NULL) AND (array_length(bl.countries, 1) > 0)) THEN c.country_code
                            ELSE '*'::text
                        END AS country_code
                   FROM (base_licenses bl
                     LEFT JOIN LATERAL ( SELECT unnest(bl.countries) AS country_code) c ON (((bl.countries IS NOT NULL) AND (cardinality(bl.countries) > 0))))
                ), main_countries AS (
                 SELECT DISTINCT bl.episode_id,
                        CASE
                            WHEN ((bl.countries IS NOT NULL) AND (array_length(bl.countries, 1) > 0)) THEN c.country_code
                   ...
                   FROM ((base_licenses bl
                     LEFT JOIN LATERAL ( SELECT unnest(bl.countries) AS country_code) c ON (((bl.countries IS NOT NULL) AND (cardinality(bl.countries) > 0))))
                     CROSS JOIN ts)
                  WHERE (ts.current_ts >= COALESCE(bl.start_time, ('-infinity'::timestamp without time zone)::timestamp with time zone))
                ), license_countries AS (
                 SELECT trailer_countries.episode_id,
                    trailer_countries.country_code,
                    'TRAILER'::text AS type
                   FROM trailer_countries
                UNION
                 SELECT main_countries.episode_id,
                    main_countries.country_code,
                    'MAIN'::text AS type
                   FROM main_countries
                )
         SELECT ev.id,
            ...
            ev.main_url,
            COALESCE(lc.country_code, '*'::text) AS country_code
           FROM (app_public.episode_videos ev
             JOIN license_countries lc ON (((lc.episode_id = ev.episode_id) AND (ev.type = lc.type))))) evc
  WHERE ((country_code = COALESCE(NULLIF(( SELECT current_setting('mosaic.country_code'::text, true) AS current_country_code), ''::text), '*'::text)) OR (country_code = '*'::text));
...
--
-- Name: TABLE movie_images; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.movie_images IS '@omit
...
--
-- Name: movie_images_view; Type: VIEW; Schema: app_public; Owner: -
--
...
--
-- Name: VIEW movie_images_view; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON VIEW app_public.movie_images_view IS '@name movie_images
@primaryKey id';
...
--
-- Name: movie_videos_view; Type: VIEW; Schema: app_public; Owner: -
--

CREATE VIEW app_public.movie_videos_view AS
 SELECT DISTINCT ON (id) id,
    movie_id,
    type,
    title,
   ...
   FROM ( WITH ts AS (
                 ...
                 SELECT ml.movie_id,
                   ...
                   FROM (app_public.movie_licenses ml
                     CROSS JOIN ts)
                  WHERE (ts.current_ts < COALESCE(ml.end_time, ('infinity'::timestamp without time zone)::timestamp with time zone))
                ), trailer_countries AS (
                 ...
                 SELECT trailer_countries.movie_id,
                    trailer_countries.country_code,
                    'TRAILER'::text AS type
                   FROM trailer_countries
                UNION
                 SELECT main_countries.movie_id,
                    main_countries.country_code,
                    'MAIN'::text AS type
                   FROM main_countries
                )
         SELECT mv.id,
           ...
           FROM (app_public.movie_videos mv
             JOIN license_countries lc ON (((lc.movie_id = mv.movie_id) AND (lc.type = mv.type))))) mvc
  WHERE ((country_code = COALESCE(NULLIF(( SELECT current_setting('mosaic.country_code'::text, true) AS current_country_code), ''::text), '*'::text)) OR (country_code = '*'::text));
...
--
-- Name: TABLE season_images; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.season_images IS '@omit
...
--
-- Name: season_images_view; Type: VIEW; Schema: app_public; Owner: -
--
...
--
-- Name: VIEW season_images_view; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON VIEW app_public.season_images_view IS '@name season_images
@primaryKey id';
...
--
-- Name: TABLE tvshow_images; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.tvshow_images IS '@omit
...
--
-- Name: tvshow_images_view; Type: VIEW; Schema: app_public; Owner: -
--
...
--
-- Name: VIEW tvshow_images_view; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON VIEW app_public.tvshow_images_view IS '@name tvshow_images
@primaryKey id';
...
--
-- Name: idx_collection_items_relation_collection_fk_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_collection_items_relation_collection_fk_id ON app_public.collection_items_relation USING btree (collection_fk_id);
...
--
-- Name: idx_episode_licenses_episode_id_end_time; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_episode_licenses_episode_id_end_time ON app_public.episode_licenses USING btree (episode_id, end_time);
...
--
-- Name: idx_episode_tvshow_id; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_episode_tvshow_id ON app_public.episode USING btree (tvshow_id);
...
--
-- Name: idx_episode_videos_episode_id_type; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_episode_videos_episode_id_type ON app_public.episode_videos USING btree (episode_id, type);
...
--
-- Name: idx_movie_licenses_movie_id_end_time; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_movie_licenses_movie_id_end_time ON app_public.movie_licenses USING btree (movie_id, end_time);
...
--
-- Name: idx_movie_videos_movie_id_type; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX idx_movie_videos_movie_id_type ON app_public.movie_videos USING btree (movie_id, type);
...
--
-- Name: collection_items_relation collection_items_relation_collection_fk_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.collection_items_relation
    ADD CONSTRAINT collection_items_relation_collection_fk_id_fkey FOREIGN KEY (collection_fk_id) REFERENCES app_public.collection(id) ON DELETE CASCADE;
...
GRANT SELECT,INSERT,DELETE ON TABLE app_hidden.outbox TO catalog_service_gql_role;
...
GRANT UPDATE(locked_until) ON TABLE app_hidden.outbox TO catalog_service_gql_role;
...
GRANT UPDATE(processed_at) ON TABLE app_hidden.outbox TO catalog_service_gql_role;
...
GRANT UPDATE(abandoned_at) ON TABLE app_hidden.outbox TO catalog_service_gql_role;
...
GRANT UPDATE(started_attempts) ON TABLE app_hidden.outbox TO catalog_service_gql_role;
...
GRANT UPDATE(finished_attempts) ON TABLE app_hidden.outbox TO catalog_service_gql_role;
...
GRANT ALL ON FUNCTION app_hidden.next_outbox_messages(max_size integer, lock_ms integer) TO catalog_service_gql_role;
...
--
-- Name: TABLE collection_images_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.collection_images_view TO catalog_service_gql_role;
...
--
-- Name: COLUMN collection_items_relation.collection_fk_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(collection_fk_id),UPDATE(collection_fk_id) ON TABLE app_public.collection_items_relation TO catalog_service_gql_role;


--
-- Name: COLUMN collection_items_relation.collection_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(collection_id),UPDATE(collection_id) ON TABLE app_public.collection_items_relation TO catalog_service_gql_role;
...
--
-- Name: TABLE episode_images_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.episode_images_view TO catalog_service_gql_role;
...
--
-- Name: TABLE episode_videos_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.episode_videos_view TO catalog_service_gql_role;
...
--
-- Name: TABLE movie_images_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.movie_images_view TO catalog_service_gql_role;
...
--
-- Name: TABLE movie_videos_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.movie_videos_view TO catalog_service_gql_role;
...
--
-- Name: TABLE season_images_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.season_images_view TO catalog_service_gql_role;
...
--
-- Name: TABLE tvshow_images_view; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.tvshow_images_view TO catalog_service_gql_role;
